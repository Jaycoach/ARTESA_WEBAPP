...
- [Tabla: login_history](docs/database-structure.md#tabla-login-history)
- [Tabla: order_details](docs/database-structure.md#tabla-order-details)
- [Tabla: orders](docs/database-structure.md#tabla-orders)
- [Tabla: orders_audit](docs/database-structure.md#tabla-orders-audit)
- [Tabla: password_resets](docs/database-structure.md#tabla-password-resets)
- [Tabla: products](docs/database-structure.md#tabla-products)
- [Tabla: roles](docs/database-structure.md#tabla-roles)
- [Tabla: tokens](docs/database-structure.md#tabla-tokens)
- [Tabla: users](docs/database-structure.md#tabla-users)
- [Tabla: v_login_analysis](docs/database-structure.md#tabla-v-login-analysis)
